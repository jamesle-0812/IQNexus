...
/***************************************************************************
* SECTION ADDED BY M2M TECHNOLOGIES
*  This section adds header for debug_uart.h, global.h, and supporting macro
***************************************************************************/
/**/#include "debug_uart.h"
/**/#include "global.h"
/**/
/**/#ifdef DISABLE_REGION_SPECIFIC_DEBUG
/**/	#define Debug_printf(...)
/**/#else
/**/	#define Debug_printf(...) Debug_printf(__VA_ARGS__)
/**/#endif
/***************************************************************************
* END OF SECTION ADDED BY M2M TECHNOLOGIES
***************************************************************************/
...
bool RegionUS915NextChannel( NextChanParams_t* nextChanParams, uint8_t* channel, TimerTime_t* time, TimerTime_t* aggregatedTimeOff )
{
	...
	/***************************************************************************
	* SECTION ADDED BY M2M TECHNOLOGIES
	*  This section forces the channel to be repeated if we are sending the
	*  first data after joining
	***************************************************************************/
	/**/static int16_t join_sequence_125 = 32;
	/**/static int16_t join_repeat_125   = 0;
	/**/static int16_t join_sequence_500 = 0;
	/**/uint8_t join_tmp;
	/**/
	/**/
	/**/static uint8_t last_channel = 0;
	/**/static int8_t last_dataRate = 0;
	/**/static bool was_joined      = false;
	/**/static bool first_tx_delay  = true;
	/**/
	/**/MibRequestConfirm_t mibreq;
	/**/
	/**/if(was_joined == false && nextChanParams->Joined == true)
	/**/{
	/**/	//Set the data rate appropriatly, to ensure that the downlink can be received.
	/**/	mibreq.Type = MIB_CHANNELS_DATARATE;
	/**/	mibreq.Param.ChannelsDatarate = last_dataRate;
	/**/	LoRaMacMibSetRequestConfirm(&mibreq);
	/**/
	/**/	if(first_tx_delay == true)
	/**/	{
	/**/		first_tx_delay = false;
	/**/		//apply a ~30 second holdoff before reusing the channel, to
	/**/		//satisify the FCC Part 15 regulations.
	/**/			//The average dwell time on a particular channel shall not
	/**/			//exceed 400 mS within a 20 second period.
	/**/		*time = 21000;
	/**/		return true;
	/**/	}
	/**/	first_tx_delay    = true;
	/**/	*channel          = last_channel;
	/**/	was_joined        = nextChanParams->Joined;
	/**/	join_sequence_125 = 32;
	/**/	join_repeat_125   = 0;
	/**/	join_sequence_500 = 0;
	/**/	return true;
	/**/}
	/**/
	/**/was_joined = nextChanParams->Joined;
	/**/last_dataRate = nextChanParams->Datarate;
	/***************************************************************************
	* END OF SECTION ADDED BY M2M TECHNOLOGIES
	***************************************************************************/
    ...
    if( nbEnabledChannels > 0 )
    {
		*channel = enabledChannels[randr( 0, nbEnabledChannels - 1 )];
		/***************************************************************************
		* SECTION ADDED BY M2M TECHNOLOGIES
		*  This section uses more deterministic channel hopping during join, to
		*  ensure better chance of hitting supported channels.
		***************************************************************************/
        /**/// We found a valid channel
		/**/// M2M: USE more deterministic channel hopping when attempting to join
		/**/if(!nextChanParams->Joined)
		/**/{
		/**/	Debug_printf("DataRate: %d\r\n", nextChanParams->Datarate);	
		/**/	if(nextChanParams->Datarate >= DR_4)
		/**/	{
		/**/		//500kHz channels (64-71)
		/**/		join_tmp = US915_MAX_NB_CHANNELS - 8 + join_sequence_500;
		/**/		join_sequence_500++;
		/**/		join_sequence_500 = join_sequence_500%8;
		/**/	}
		/**/	else
		/**/	{
		/**/		//125kHz channels
		/**/		join_tmp = join_sequence_125 + join_repeat_125;
		/**/		//gateways tend to clump their channels in groups of 8, i.e. 0-7, 8-15, etc
		/**/		//channel 0-72
		/**/		join_sequence_125+=8;
		/**/		if(join_sequence_125 >= US915_MAX_NB_CHANNELS-8)
		/**/		{
		/**/			join_sequence_125 = 0;
		/**/			join_repeat_125 ++;
		/**/		}
		/**/		join_repeat_125 = join_repeat_125 %7;
		/**/	}
		/**/	
		/**/	Debug_printf("channel: %d\r\n",join_tmp);
		/**/	//by defniition, from the spec, we know that at power on we support all 72 channels.
		/**/	*channel = join_tmp;
