...
#ifndef UART_DEBUG_HEADER_PRIVATE
#define UART_DEBUG_HEADER_PRIVATE
#include <stdint.h>
#include <stdarg.h>
 ...
 ********************************************************************/
//Clock Selection
#define USART1_CLOCK_SELECTION_ADDR (USART_CLOCK_t*)0x4002104C
#define USART1_CLKEN_ADDR	(RCC_APB2ENR_t*)0x40021034

//UART1
#define USART1_BASE_ADDR	0x40013800
#define USART1_CR1_ADDR (USART_CR1_t*)0x40013800
#define USART1_CR3_ADDR (USART_CR3_t*)0x40013808
#define USART1_BRR_ADDR (USART_BRR_t*)0x4001380C
#define USART1_RDR_ADDR (USART_RDR_t*)0x40013824
#define USART1_TDR_ADDR (USART_TDR_t*)0x40013828
#define USART1_ISR_ADDR (USART_ISR_t*)0x4001381C
#define USART1_ICR_ADDR (USART_ICR_t*)0x40013820
...
#endif //UART_DEBUG_HEADER_PRIVATE
